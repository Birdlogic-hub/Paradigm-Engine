# CardLib v0.4.4 — the Projection primitive

*Renamed StoryCard → ParaCard (7/13/2026) → CardLib. Function names keep the `SC_` prefix — they operate on AID story cards.*

*Version entries below are dated changelog records; the Event Log window they describe was widened from 10 to 20 events after v0.3.1. See `Documentation/Wiki/Modules/CardLib.md` for current behaviour.*
