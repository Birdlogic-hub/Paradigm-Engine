...
function load() {
    ...
    for (const name of arguments) {
        const src = fs.readFileSync(srcPath(name), "utf-8")
            .replace(/^const (GK_|SC_|RX_|INV_|BK_|SK_|EV_|CS_|OB_|RW_)([A-Z_]+)/gm, "var $1$2")
            .replace(/^let (GK_DEBUG_RAW|GK_CFG_CACHE|INV_CFG_CACHE|EV_REG|OB_CFG_CACHE|RW_CFG_CACHE)/gm, "var $1");
